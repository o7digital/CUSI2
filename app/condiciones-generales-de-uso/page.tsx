    ...
    <div className="min-h-screen bg-[#f6efe9] text-[#241715]">
      ...
      <main className="mx-auto w-[92%] max-w-5xl py-8 md:py-12">
        <section className="rounded-3xl border border-[#ead8cf] bg-white p-6 md:p-10">
          ...
          <p className="mt-4 text-base leading-8 text-[#5d4740]">Bienvenido al sitio web de CUSI FLORES.</p>
          <p className="mt-3 text-base leading-8 text-[#5d4740]">
            Al navegar en este sitio, contactar a CUSI FLORES, solicitar informacion, realizar un pedido o contratar alguno de nuestros productos o servicios, el usuario acepta las presentes Condiciones Generales de Uso.
          </p>
        </section>
        ...
        <section className="mt-6 space-y-6 rounded-3xl border border-[#ead8cf] bg-white p-6 md:p-10">
          <article>
            ...
            <div className="mt-4 rounded-2xl border border-[#ead8cf] bg-[#fdf8f4] p-5 text-base leading-8 text-[#5d4740]">
              <p className="font-semibold text-[#2a1c19]">CUSI FLORES</p>
          ...
          <article>
            ...
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              El sitio web de CUSI FLORES tiene como finalidad presentar informacion sobre nuestros productos, arreglos florales, servicios, promociones, contacto, entregas y opciones comerciales relacionadas con flores, decoracion floral, regalos y eventos.
            </p>
          ...
          <article>
            ...
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              CUSI FLORES procurara respetar el diseno, estilo y calidad solicitados por el cliente. Sin embargo, algunos productos naturales pueden presentar variaciones en color, tamano, forma o disponibilidad.
            </p>
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              En caso de no contar con una flor, material o producto especifico, CUSI FLORES podra proponer una alternativa similar, procurando mantener el valor, estetica y calidad del pedido.
            </p>
          </article>
          ...
          <article>
            ...
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              Los pedidos podran realizarse a traves del sitio web, telefono, WhatsApp, redes sociales, correo electronico o cualquier otro medio autorizado por CUSI FLORES.
            </p>
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              Un pedido se considerara confirmado una vez que CUSI FLORES haya validado la informacion del cliente, disponibilidad del producto, condiciones de entrega y pago correspondiente.
            </p>
          </article>
          ...
          <article>
            ...
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              Los precios publicados o comunicados por CUSI FLORES podran variar segun temporada, disponibilidad, tipo de producto, diseno, tamano, urgencia, distancia de entrega o requerimientos especiales.
            </p>
            <p className="mt-3 text-base leading-8 text-[#5d4740]">CUSI FLORES informara al cliente el precio aplicable antes de confirmar el pedido.</p>
          </article>
          ...
          <article>
            ...
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              CUSI FLORES no sera responsable por retrasos o entregas fallidas cuando los datos proporcionados por el cliente sean incorrectos, incompletos o cuando no haya una persona disponible para recibir el pedido.
            </p>
          </article>
          ...
          <article>
            ...
            <p className="mt-3 text-base leading-8 text-[#5d4740]">CUSI FLORES revisara cada caso de forma individual.</p>
          </article>
          ...
          <article>
            ...
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              CUSI FLORES no sera responsable por errores ortograficos, nombres incorrectos o mensajes enviados de forma incompleta por el cliente.
            </p>
          </article>
          ...
          <article>
            ...
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              Todos los textos, imagenes, disenos, logotipos, fotografias, composiciones visuales y contenidos del sitio son propiedad de CUSI FLORES o se utilizan con autorizacion correspondiente.
            </p>
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
          ...
          <article>
            ...
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              CUSI FLORES procura mantener la informacion del sitio actualizada y correcta. Sin embargo, no garantiza que el sitio este libre de errores, interrupciones tecnicas o informacion desactualizada.
            </p>
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              CUSI FLORES no sera responsable por danos derivados del uso indebido del sitio, fallas tecnicas externas, interrupciones de internet o acciones de terceros.
            </p>
          </article>
          ...
          <article>
            ...
            <p className="mt-3 text-base leading-8 text-[#5d4740]">
              CUSI FLORES podra modificar estas Condiciones Generales de Uso en cualquier momento, por cambios legales, comerciales, operativos o tecnicos.
            </p>
          ...
          <article>
            ...
            <p className="mt-3 text-base leading-8 text-[#5d4740]">Para cualquier duda relacionada con estas Condiciones Generales de Uso, puede contactar a CUSI FLORES a traves de:</p>
