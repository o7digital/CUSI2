...
export const metadata: Metadata = {
  title: 'Termini di utilizzo | CUSI Flowers',
  description:
    'Termini generali di utilizzo del sito CUSI Flowers: ordini, consegne, disponibilita e responsabilita.',
  alternates: {
    canonical: 'https://www.cusiflores.com/it/terms-of-use',
  },
}

export default function TermsOfUsePageIt() {
  return (
    <div className="min-h-screen bg-[#f6efe9] text-[#241715]">
      ...
      <main className="mx-auto w-[92%] max-w-5xl py-8 md:py-12">
        <section className="rounded-3xl border border-[#ead8cf] bg-white p-6 md:p-10">
          <h1 className="text-3xl leading-tight md:text-5xl">Termini di utilizzo</h1>
          <p className="mt-4 text-sm text-[#6f5851]">Ultimo aggiornamento: Aprile 2026</p>
          <p className="mt-4 text-base leading-8 text-[#5d4740]">
            Navigando su questo sito o effettuando un ordine con CUSI, l'utente accetta i presenti termini di utilizzo.
          </p>
        </section>
      </main>
