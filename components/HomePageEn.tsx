...
const BRAND = {
  name: 'CUSI',
  city: 'Mexico City',
  whatsappUrl: 'https://wa.me/525521092665?text=Hello%20CUSI%20FLOWERS%2C%20I%20would%20like%20to%20place%20a%20premium%20order.',
...
const emotionalPillars = [
  { title: 'Selected flowers', text: 'Floral curation focused on quality, freshness, and visual harmony.' },
  { title: 'Design with intention', text: 'Each arrangement is crafted to communicate emotion and elegance.' },
  { title: 'Careful delivery', text: 'Personalized attention and scheduled delivery in selected zones.' },
]
...
const footerSeoText =
  "premium florist CDMX · premium flower delivery in CDMX · flower delivery CDMX · floral arrangements CDMX · flower bouquets CDMX · Mother's Day flowers Lomas de Chapultepec CDMX · May 10 floral arrangements Lomas de Chapultepec CDMX · flowers for mom CDMX · premium bouquets CDMX · orchid delivery CDMX · tulip bouquets Lomas de Chapultepec CDMX · tulips in glass cylinder Lomas de Chapultepec CDMX · premium rose bouquet Lomas de Chapultepec CDMX · yellow rose box Lomas de Chapultepec CDMX · birthday flower arrangements Lomas de Chapultepec CDMX · anniversary flower arrangements Lomas de Chapultepec CDMX · floral gifts CDMX · florist in Bosques de las Lomas · WhatsApp flower orders Lomas de Chapultepec CDMX · CUSI Flowers Lomas de Chapultepec CDMX"
...
export default function CusiFloresEnPage() {
  ...
  useEffect(() => {
    ...
    const loadProducts = async () => {
      try {
        ...
        if (isMounted) {
          setProducts([])
          setProductsError("We couldn't load products right now. Please try again in a few minutes.")
        }
        console.error(error)
      } finally {
        if (isMounted) {
            ...
            {products.map((item) => (
              <article key={item.title} className="flex h-full flex-col overflow-hidden rounded-[1.6rem] border border-[#ead8cf] bg-[#fffdfa] shadow-[0_16px_42px_rgba(74,46,37,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_58px_rgba(74,46,37,0.14)]">
                <div className="flex h-52 items-center justify-center bg-[#f7efea] px-4 py-3 md:h-56">
                  <img src={item.image} alt={`Premium floral arrangement ${item.title} CUSI CDMX`} className="h-full w-full object-contain scale-[1.2]" loading="lazy" />
                </div>
      ...
      <footer className="mt-10 bg-[#1f2024] text-white">
        <div className="mx-auto w-[92%] max-w-7xl py-14 md:py-16">
          <div className="grid gap-5 md:grid-cols-3">
            <a href="#coleccion" className="group block min-h-[180px] rounded-md border border-white/10 bg-[#26272d] px-6 py-7 transition duration-300 hover:border-white/30"><span className="text-3xl font-light tracking-wide text-white/95">COLLECTION</span></a>
            <a href="#pedido" className="group block min-h-[180px] rounded-md border border-white/10 bg-[#26272d] px-6 py-7 transition duration-300 hover:border-white/30"><span className="text-3xl font-light tracking-wide text-white/95">ORDERS</span></a>
            <a href="#contacto" className="group block min-h-[180px] rounded-md border border-white/10 bg-[#26272d] px-6 py-7 transition duration-300 hover:border-white/30"><span className="text-3xl font-light tracking-wide text-white/95">CONTACT</span></a>
          </div>
          <div className="mt-12 border-t border-white/15 pt-10 text-center">
            <p className="text-4xl text-[#b99657] md:text-6xl">Book Your Order</p>
            <a href={BRAND.whatsappUrl} target="_blank" rel="noreferrer" className="mx-auto mt-7 inline-flex min-h-[58px] min-w-[320px] items-center justify-center rounded-sm bg-[#b99657] px-8 text-sm font-semibold uppercase tracking-[0.04em] text-white transition hover:bg-[#a7864d]">Order on WhatsApp now</a>
          </div>
        </div>
        <div className="bg-black py-6">
          <div className="mx-auto flex w-[92%] max-w-7xl flex-col gap-5">
            <div className="flex flex-wrap items-center justify-between gap-3 text-xs text-white/90">
              <p>© Copyright 2026 CUSI Flowers |</p>
              <div className="flex items-center gap-3">
                <a href="/en/privacy-policy" className="transition hover:text-white">Privacy Policy</a>
                <a href="/en/tax-information" className="transition hover:text-white">Tax Information</a>
                <a href="/en/terms-of-use" className="transition hover:text-white">Terms of Use</a>
              </div>
            </div>
