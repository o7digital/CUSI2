...
const footerSeoText =
  "fleuriste premium CDMX · livraison de fleurs premium à CDMX · livraison de fleurs CDMX · compositions florales CDMX · bouquets de fleurs CDMX · fleurs Fête des Mères Lomas de Chapultepec CDMX · compositions florales 10 mai Lomas de Chapultepec CDMX · fleurs pour maman CDMX · bouquets premium CDMX · livraison d'orchidées CDMX · bouquets de tulipes Lomas de Chapultepec CDMX · tulipes en cylindre de verre Lomas de Chapultepec CDMX · bouquet de roses premium Lomas de Chapultepec CDMX · boîte de roses jaunes Lomas de Chapultepec CDMX · compositions florales anniversaire Lomas de Chapultepec CDMX · compositions florales d'anniversaire de mariage Lomas de Chapultepec CDMX · cadeaux floraux CDMX · fleuriste Bosques de las Lomas · commandes de fleurs par WhatsApp Lomas de Chapultepec CDMX · CUSI Flowers Lomas de Chapultepec CDMX"
      ...
      <main id="inicio">
            ...
            {products.map((item) => (
              <article key={item.title} className="flex h-full flex-col overflow-hidden rounded-[1.6rem] border border-[#ead8cf] bg-[#fffdfa] shadow-[0_16px_42px_rgba(74,46,37,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_58px_rgba(74,46,37,0.14)]">
                <div className="flex h-52 items-center justify-center bg-[#f7efea] px-4 py-3 md:h-56">
                  <img src={item.image} alt={`Composition florale premium ${item.title} CUSI CDMX`} className="h-full w-full object-contain scale-[1.2]" loading="lazy" />
                </div>
        ...
        <div className="mx-auto w-[92%] max-w-7xl py-14 md:py-16">
          <div className="grid gap-5 md:grid-cols-3">
            ...
            <a href="#pedido" className="group block min-h-[180px] rounded-md border border-white/10 bg-[#26272d] px-6 py-7 transition duration-300 hover:border-white/30"><span className="text-3xl font-light tracking-wide text-white/95">RENDEZ-VOUS</span></a>
          ...
          <div className="mt-12 border-t border-white/15 pt-10 text-center">
            <p className="text-4xl text-[#b99657] md:text-6xl">Reservez votre commande</p>
            <a href={BRAND.whatsappUrl} target="_blank" rel="noreferrer" className="mx-auto mt-7 inline-flex min-h-[58px] min-w-[320px] items-center justify-center rounded-sm bg-[#b99657] px-8 text-sm font-semibold uppercase tracking-[0.04em] text-white transition hover:bg-[#a7864d]">Commander sur WhatsApp</a>
          </div>
        </div>
          ...
          <div className="mx-auto flex w-[92%] max-w-7xl flex-col gap-5">
            <div className="flex flex-wrap items-center justify-between gap-3 text-xs text-white/90">
              ...
              <div className="flex items-center gap-3">
                <a href="/fr/privacy-policy" className="transition hover:text-white">Privacy</a>
                <a href="/fr/tax-information" className="transition hover:text-white">Tax</a>
                <a href="/fr/terms-of-use" className="transition hover:text-white">Terms</a>
              </div>
            </div>
